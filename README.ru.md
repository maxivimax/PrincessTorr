...
<p align="center">
  <img src="docs/screenshots/4.%20movie%20info.webp" width="49%" alt="Каталог: постер и описание">
  <img src="docs/screenshots/7.%20torrents.webp" width="49%" alt="Список раздач с фильтрами">
</p>

Больше в [SCREENSHOTS.md](SCREENSHOTS.md) · [галерея онлайн](https://maxivimax.github.io/PrincessTorr/screenshots.html).
...
Аддон предоставляется исключительно в образовательных целях. Он не хранит и не
индексирует никакой контент — только обращается к сторонним сервисам, которые
настраивает сам пользователь. Используйте только с контентом, к которому у вас
есть законный доступ. Автор не несёт ответственности за способы использования.
